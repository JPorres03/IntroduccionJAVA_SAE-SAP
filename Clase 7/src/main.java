...
public class main { 
    ...
    public static void clase5_6(){
        System.out.println("---------------------------- POO (Programacion Orientada a Objetos) ---------------------------- ");
        clase5_6_ENCAPSULAMINETO();
        clase5_6_HERENCIA();
        clase5_6_POLIMORFISMO();
        clase5_6_ABSTRACCION();
    }
    
    
    public static void clase5_6_ENCAPSULAMINETO(){
        System.out.println("\n ------------- ENCAPSULAMIENTO ------------- ");
        CuentaBancaria cuenta = new CuentaBancaria("Josue", 500);
        cuenta.depositar(100);
        cuenta.retirar(200);
        System.out.println("Saldo actual: Q" + cuenta.getSaldo() + " del senior: " + cuenta.getTitular());
    }
    
    public static void clase5_6_HERENCIA(){
        System.out.println("\n ------------- HERENCIA ------------- ");
     ...
     public static void clase5_6_POLIMORFISMO(){
        System.out.println("\n ------------- POLIMORFISMO ------------- ");
    ...
    public static void clase5_6_ABSTRACCION(){
        System.out.println("\n ------------- ABSTRACCION ------------- ");
        Figura[] figuras = {
            new Circulo("azul",3), 
            new Rectangulo("rojo",4,6)
        };
    ...
    try{
        ...
        System.out.println("El codigo ya termino");
    }
    ...
    System.out.println("Error: El texto no se puede convertir a INT");
    } catch (Exception e) {
    ...
    try {
        int edad = 15;
        if (edad < 18){
            throw new IllegalArgumentException ("Debe ser mayor de edad, para ingresar");
        }
    } catch(IllegalArgumentException e){
    System.out.println("Error: Edad invalida detectada");
    System.out.println("Error: " + e.getMessage());
    }
    ...
    try{
        if (retiro > saldo){
            throw new SaldoInsuficienteException(
                "Saldo insuficiente. Saldo actual: Q" + saldo + ", Retiro de: Q" + retiro
            );
        }
